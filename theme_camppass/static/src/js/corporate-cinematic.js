...
(function () {
    ...
    // Run when DOM is ready or when corporate page is shown
    ...
    // Re-init when page is switched (preview nav)
    document.addEventListener('click', function (e) {
        var btn = e.target.closest('.preview-nav-btn');
        if (btn && btn.dataset.page === 'corporate') {
            setTimeout(initCorporate, 100);
        }
    });
})();
